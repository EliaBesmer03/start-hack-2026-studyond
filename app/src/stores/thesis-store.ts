...
const DEFAULT_TASKS: Task[] = [
  ...
  },
  {
    ...
    description: 'Methodology, thesis proposal, supervisor milestones, and registration — all in one place.',
    featureId: 'planning-copilot',
    status: 'ready',
  },
  ...
  },
  {
    id: 'e3',
    stageId: 'planning',
    title: 'Analysis Co-Pilot',
    description: 'Data collection, analysis, and findings — Co-Pilot guides you from raw data to a polished chapter.',
    featureId: 'analysis-copilot',
    status: 'ready',
  },
